...
<script type="text/javascript" src="/jsphomme/resources/js/jquery-3.3.1.js"></script>
...
<nav class="paging">
		<ul>
			<li><a href="#" onclick="goPageFnc(${pagingMap.paging.prevPage});"><span>≪</span></a></li>
			...
			<li><a href="#" onclick="goPageFnc(${pagingMap.paging.nextPage});"><span>≫</span></a></li>
		</ul>
	</nav>
